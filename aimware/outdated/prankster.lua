...
gui.Combobox(ref_msc_general_extra, "msc_teamdamage", "Team Damage", "Off", "Without Colors", "Matchmaking Colors")
...
local function draw_progressbar(vec2_pos, vec2_size, clr_colorA, clr_colorB, int_percentage, bool_centered, bool_vertical, str_valuelabel) -- Draws a progress bar
	...
	-- Draw background
	draw.Color(gui.GetValue("clr_gui_slider_bar1"))
	...
	-- Draw outline
	draw.Color(gui.GetValue("clr_gui_controls3"))
